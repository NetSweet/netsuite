...
describe NetSuite::Transactions::Invoice do
  ...
  it 'has all the right fields' do
    [
      :created_date, :last_modified_date, :custom_form, :entity, :tran_date, :tran_id, :source, :created_from,
      :posting_period, :opportunity, :department, :klass, :terms, :location, :subsidiary, :due_date, :discount_date,
      :discount_amount, :sales_rep, :contrib_pct, :partner, :lead_source, :start_date, :end_date, :other_ref_name,
      :memo, :sales_effective_date, :exclude_commission, :total_cost_estimate, :est_gross_profit, :est_gross_profit_percent,
